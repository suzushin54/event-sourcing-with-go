...
// CancelOrderV1 - 注文キャンセル
func (u *OrderController) CancelOrderV1() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = u.orderUseCaseV1.CancelV1(
			r.Context(), &usecase.CancelInputV1{OrderID: uint64(orderID)},
		)
		if err != nil {
